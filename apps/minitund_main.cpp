...
[[nodiscard]] std::string daemon_metrics_text(minitun::daemon::ServerManager& manager) {
    ...
    output
        ...
        << scalar("reconnects") << "\n"
        << "# TYPE minitun_p2p_paths_total counter\nminitun_p2p_paths_total{path=\"direct\"} "
        << count("p2p_paths", "direct") << "\nminitun_p2p_paths_total{path=\"relay\"} "
        << count("p2p_paths", "relay") << "\n"
        << "# TYPE minitun_p2p_udp_datagrams_total counter\n"
        << "minitun_p2p_udp_datagrams_total{direction=\"in\"} "
        << count("p2p_udp", "datagrams_in")
        << "\nminitun_p2p_udp_datagrams_total{direction=\"out\"} "
        << count("p2p_udp", "datagrams_out") << "\n"
        << "# TYPE minitun_p2p_udp_bytes_total counter\nminitun_p2p_udp_bytes_total{direction=\"in\"} "
        << count("p2p_udp", "bytes_in") << "\nminitun_p2p_udp_bytes_total{direction=\"out\"} "
        << count("p2p_udp", "bytes_out") << "\n"
