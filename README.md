...
The repository is currently at **development stage 0**: the build system, dependency
selection, common error/result/logging foundations, version reporting, executable
skeletons, tests, and baseline CI are present. TCP tunnelling, persistence, IPC, TLS,
and packaging are deliberately not implemented in this stage.

## Build the stage-0 baseline
